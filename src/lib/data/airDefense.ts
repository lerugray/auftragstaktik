...
export const AIR_DEFENSE_SITES: AirDefenseInstallation[] = [
  // === UKRAINE THEATER ===
  // Russian AD in occupied territories and border regions
  {
    id: 'ru-s400-crimea-1',
    system: 'S-400 Triumf',
    operator: 'Russia',
  ...
  },
  {
    ...
    lat: 50.63, lng: 36.60,
    status: 'confirmed',
    lastConfirmed: '2024-07-01',
    source: 'Open-source satellite analysis',
    theaterId: 'ukraine',
  },
  {
    id: 'ru-s400-rostov',
    ...
    source: 'Russian MoD public imagery',
    theaterId: 'ukraine',
  },
  {
    id: 'ua-patriot-kyiv',
    ...
    source: 'Public reporting, confirmed by Ukrainian officials',
    theaterId: 'ukraine',
  },
  {
    id: 'ua-nasams-1',
    ...
    status: 'suspected',
    lastConfirmed: '2024-06-01',
    source: 'Norwegian/US delivery confirmed, exact position unconfirmed',
    theaterId: 'ukraine',
  },
  {
    id: 'ua-iris-t',
    ...
    lat: 47.85, lng: 35.10,
    status: 'suspected',
    lastConfirmed: '2024-05-01',
    source: 'German delivery confirmed, general area from public reporting',
    theaterId: 'ukraine',
  },
  ...
  // === MIDDLE EAST ===
  {
    ...
    lat: 32.07, lng: 34.78,
    status: 'confirmed',
    lastConfirmed: '2024-10-01',
    source: 'Publicly known deployment zone',
  ...
  },
  {
    ...
    lat: 31.90, lng: 34.81,
    status: 'confirmed',
    lastConfirmed: '2024-04-01',
    source: 'Israeli MoD public statements',
    theaterId: 'middle-east',
  },
  {
    id: 'ir-s300-isfahan',
    system: 'S-300PMU-2',
    operator: 'Iran',
    location: 'Isfahan nuclear facility',
    lat: 32.65, lng: 51.68,
    status: 'confirmed',
    lastConfirmed: '2024-04-01',
    source: 'Satellite imagery, CSIS Missile Threat',
    theaterId: 'middle-east',
  },
  {
    id: 'ir-s300-tehran',
  ...
  },
  {
    ...
    status: 'confirmed',
    lastConfirmed: '2024-01-01',
    source: 'Public reporting, confirmed intercepts',
    theaterId: 'middle-east',
  },
  {
    id: 'sy-s300-masyaf',
    system: 'S-300PM',
    operator: 'Syria / Russia',
    location: 'Masyaf, Syria',
    lat: 35.07, lng: 36.34,
    status: 'confirmed',
    lastConfirmed: '2023-12-01',
    source: 'Satellite imagery, confirmed by Russian MoD',
    theaterId: 'middle-east',
  },
  {
    id: 'sy-s400-hmeimim',
    system: 'S-400 Triumf',
    operator: 'Russia',
    location: 'Hmeimim Air Base, Syria',
    lat: 35.41, lng: 35.95,
    status: 'confirmed',
    lastConfirmed: '2024-01-01',
    source: 'Russian MoD, satellite imagery',
    theaterId: 'middle-east',
  },

  // === BALTIC ===
  {
    id: 'ru-s400-kaliningrad',
    system: 'S-400 Triumf',
    operator: 'Russia',
    ...
    status: 'confirmed',
    lastConfirmed: '2024-01-01',
    source: 'Russian MoD public reporting, satellite imagery',
    theaterId: 'baltic',
  },
  {
    id: 'ru-s300-kaliningrad',
    system: 'S-300PM',
    operator: 'Russia',
    location: 'Baltiysk, Kaliningrad',
    lat: 54.65, lng: 19.92,
    status: 'confirmed',
    lastConfirmed: '2023-06-01',
    source: 'Satellite imagery',
    theaterId: 'baltic',
  },
];
